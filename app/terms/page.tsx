    ...
    <div className="min-h-screen bg-gray-900">
      <main className="container mx-auto px-4 py-12 max-w-4xl text-white">
        ...
        <header className="mb-10">
          ...
          <p className="mt-2 text-sm text-white">시행일: 2025-05-29</p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 leading-relaxed text-white">
              ...
              <li>
                콘텐츠: 회사 또는 제휴사가 서비스 내에서 제공하는 유·무료 정보
                및 기능
              </li>
              <li>
              ...
              <li>
                이용자: 회사가 정한 절차에 따라 콘텐츠를 무상 또는 유료로
                소비하는 회원 또는 비회원
              </li>
            </ul>
            <p className="leading-relaxed text-white">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 leading-relaxed text-white">
              ...
              <li>
                약관 개정 시 적용일자 및 개정사유를 명시하여 최소 7일 전
                공지하며, 회원에게 불리한 변경은 최소 30일 전에 공지합니다.
              </li>
              <li>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 leading-relaxed text-white">
              <li>
                회원은 회사가 정한 양식에 따라 정보를 입력하고 약관에
                동의함으로써 가입을 신청합니다. 필요한 경우 실명확인 및
                본인인증을 요청할 수 있습니다.
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 leading-relaxed text-white">
              ...
              <li>
                탈퇴 시 적립금·쿠폰 등 포인트성 혜택은 소멸되며 복구되지
                않습니다.
              </li>
            </ul>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="leading-relaxed text-white">
              원칙적으로 연중무휴 24시간 운영하나, 시스템 점검·설비 교체 등
              필요한 경우 일시 중단될 수 있습니다. 가능한 경우 사전 공지하며,
              긴급 점검 등 불가피한 경우 사후 공지할 수 있습니다.
            </p>
          </div>
          <div className="space-y-3">
            <h3 className="text-xl font-semibold text-white">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1 leading-relaxed text-white">
              <li>
                회원은 서비스 내 콘텐츠를 제공 목적 외로 무단 이용할 수
                없습니다.
              </li>
              <li>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="leading-relaxed text-white">
              회사는 서비스 운영과 관련하여 다양한 채널에 광고를 게재할 수
              있으며, 회원은 수신 거절이 가능합니다.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="leading-relaxed text-white">
              회사와 회원은 분쟁 발생 시 성실히 협의하며, 해결되지 않을 경우
              관련 법률에 따라 개인정보 분쟁조정위원회 등에 조정을 신청할 수
              있습니다.
            </p>
          </div>
          <div className="space-y-3">
